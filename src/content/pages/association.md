...
values_section:
  ...
  items:
    - idx: "01"
      title: Durabilité
      body: Valoriser une essence naturellement résistante — classe 4 — sans aucun traitement chimique.
    - idx: "02"
      title: Proximité
      body: Favoriser les circuits courts et l'économie locale, du peuplement à l'atelier.
    - idx: "03"
      title: Innovation
